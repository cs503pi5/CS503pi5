...
def right_turn(curr_odom_):
    
    curr_odom = curr_odom_

    count = 0
    # while (curr_odom[2] < math.pi/2 - .13):
    while (curr_odom[2] > -math.pi/2 + 0.2):
...
if __name__ == "__main__":
    ...
    curr_odom = run_straight_x(127,curr_odom)
    print("Left turn...")
    curr_odom = right_turn(curr_odom)
    print("Running straight...")
    curr_odom = run_straight_y(53,curr_odom)
    print("Stopping...")
    stop()
    print(curr_odom)
