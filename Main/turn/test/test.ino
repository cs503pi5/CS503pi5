...
// }
  ...
  double duration = (double)(end_millis - start_millis);//microsecond
  // duration_pad = 0.0;
...
void turn(int degree, int lpwm ,int rpwm) //input degree
{
  ...
  long turn_left_c = 2*3.2*left_wheel_r*degree/360;//the length of walking on the left wheel when turning

  long turn_right_c = 2*3.2*right_wheel_r*degree/360;//the length of walking on the right wheel when turning     
